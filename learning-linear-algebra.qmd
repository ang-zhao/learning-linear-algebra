...
- Here $Q$ has orthonormal columns ($q_1^\top q_2 = 1$).
- $R$ collecting the projection coefficients $q_i^\top a_j$, upper triangular.

---

Geometrically $Q$ rotates the correlated columns of $A$ into perpendicular directions, $R$ rescales columns to preserving numerical stability. Below is the $Q$ step.
...
cat("Equilibria:\n"); print(eq_df)
cat("\nJacobian at chosen equilibrium (x*,y*):\n"); print(J)
cat("\nEigenvalues:\n"); print(eig$values)
cat("Eigenvectors:\n"); print(eig$vectors)
...
- **Principal components (eigenvectors):** $V = [v_1, \dots, v_p]$  
